/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   Module Name          : cc.macloud.core.message.service.impl.MailServiceImpl
   Module Description   :
   ...
   ------------------------------------------------------------------------------
   ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
package cc.macloud.core.message.service.impl;
...
public class MailServiceImpl extends DomainServiceImpl<Mail> implements MailService {
	...
	/** mail from */
	private String from = "\"Robit\" <robit@macloud.cc>";
	 ...
	 * (non-Javadoc)
	 *
	 * @see cc.macloud.core.message.service.MailService#sendMail(java.lang.String, java.lang.String, java.lang.String,
	 * java.lang.String, java.lang.String, java.util.Map, java.util.Map, java.lang.String)
	 */
	@Override
	public void sendMail(String to, String cc, String bcc, String subject, String body, Map<String, String> inlines, Map<String, String> attachments,
	 ...
	 * (non-Javadoc)
	 *
	 * @see cc.macloud.core.message.service.MailService#sendMail(cc.macloud.core.message .entity.Mail)
	 */
	@Override
	@Transactional(readOnly = false)
	public boolean sendMail(Mail mail) throws CoreException {
		...
		try {
			if (!mail.isSend()) {
				sendMail(mail.getTo(), mail.getCc(), mail.getBcc(), mail.getSubject(), mail.getBody(), mail.getInlines(), mail.getAttachments(),
						mail.getFrom());
				mail.setSend(true);
				logger.info("send mail oid:{}, subject:{}, to:{}", new Object[] { mail.getOid(), mail.getSubject(), mail.getTo() });
			}
			result = true;
		} catch (Exception e) {
	 ...
	 * (non-Javadoc)
	 *
	 * @see cc.macloud.core.message.service.MailService#getNoneSendMails(int, int)
	 */
	@Override
